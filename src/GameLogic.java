...
//		BotMemory b=new BotMemory();
//		GameLogic game = new GameLogic(b);
//		b.addBot(1);
//		ArrayList<int[]> a= game.map.lookB(2, 3);
//		for(int i=0; i<a.size();i++) {
//			int[] ba= a.get(i);
////			System.out.println(Arrays.toString((ba)));
//		}
//		System.out.println(a.size());
//		b.storeNewViewLocations(1, a);
//		
//		a= game.map.lookB(2, 4);
//
//		b.storeNewViewLocations(1, a);
//		ArrayList<int []> d= b.getBotView(1);
...
///---------------------------------	-------------------------------------------------------------------------------
	public GameLogic(BotMemory botMemory){
		map=new Map();			
